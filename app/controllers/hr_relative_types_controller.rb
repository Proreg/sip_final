class HrRelativeTypesController < ApplicationController
  ...
  MODEL_NAME = HrRelativeType #First letter uppercase
  SYMBOL_NAME = :hr_relative_type #lowercase and separated by underscore
  ...
  def create
    ...
    if @model_instance.save
      flash[:msg_success] = 'Parentesco cadastrado com sucesso.'
