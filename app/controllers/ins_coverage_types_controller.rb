class InsCoverageTypesController < ApplicationController
  ...
  MODEL_NAME = InsCoverageType #First letter uppercase
  SYMBOL_NAME = :ins_coverage_type #lowercase and separated by underscore
  PARAMETERS = :description  #Used by the getter, getting the params from specific models
