class HrSectorsController < ApplicationController
  ...
  MODEL_NAME = HrSector #First letter uppercase
  SYMBOL_NAME = :hr_sector #lowercase and separated by underscore
  ...
  def create
    ...
    if @model_instance.save
      flash[:msg_success] = 'Setor cadastrado com sucesso.'
