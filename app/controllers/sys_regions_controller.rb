class SysRegionsController < ApplicationController
  ...
  MODEL_NAME = SysRegion #First letter uppercase
  SYMBOL_NAME = :sys_region #lowercase and separated by underscore
