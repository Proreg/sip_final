class HrMaritalStatusesController < ApplicationController
  ...
  MODEL_NAME = HrMaritalStatus #First letter uppercase
  SYMBOL_NAME = :hr_marital_status #lowercase and separated by underscore
  ...
  def create
    ...
    if @model_instance.save
      flash[:msg_success] = 'Estado civil cadastrado com sucesso.'
