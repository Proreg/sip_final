class HrEmployeePhonesController < ApplicationController
  ...
  MODEL_NAME = HrEmployeePhone #First letter uppercase
  SYMBOL_NAME = :hr_employee_phone #lowercase and separated by underscore
  PARAMETERS = :area_code, :phone_number, :sys_telephone_type_id, :hr_employee_id  #Used by the getter, getting the params from specific models
  ...
  def create
    ...
    if @model_instance.save
      flash[:msg_success] = 'Telefone do funcionário cadastrado com sucesso.'
