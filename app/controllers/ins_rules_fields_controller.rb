class InsRulesFieldsController < ApplicationController
  ...
  MODEL_NAME = InsRulesField #First letter uppercase
  SYMBOL_NAME = :ins_rules_field #lowercase and separated by underscore
