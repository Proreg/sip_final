class SysMenusController < ApplicationController
  ...
  MODEL_NAME = SysMenu #First letter uppercase
  SYMBOL_NAME = :sys_menu #lowercase and separated by underscore
  PARAMETERS = :description, :order_menu, :action, :controller  #Used by the getter, getting the params from specific models
