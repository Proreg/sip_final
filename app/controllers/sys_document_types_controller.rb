class SysDocumentTypesController < ApplicationController
  ...
  MODEL_NAME = SysDocumentType #First letter uppercase
  SYMBOL_NAME = :sys_document_type #lowercase and separated by underscore
