class SysCitiesController < ApplicationController
  ...
  MODEL_NAME = SysCity #First letter uppercase
  SYMBOL_NAME = :sys_city #lowercase and separated by underscore
  ...
  def valid_params
    params.require(SYMBOL_NAME).permit(:description, :sys_state_id)#params require é usado para updates de varios valores. Nesse exemplo apenas um foi alterado
  end
