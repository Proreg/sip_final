class InsImportRulesController < ApplicationController
  ...
  MODEL_NAME = InsImportRule #First letter uppercase
  SYMBOL_NAME = :ins_import_rule #lowercase and separated by underscore
  PARAMETERS = :ins_insurance_company_id, :ins_rules_field_id, :limit_begin, :limit_end  #Used by the getter, getting the params from specific models
