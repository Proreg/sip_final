class SysCountriesController < ApplicationController
  ...
  MODEL_NAME = SysCountry #First letter uppercase
  SYMBOL_NAME = :sys_country #lowercase and separated by underscore
