class SysStateXRegionsController < ApplicationController
  ...
  MODEL_NAME = SysStateXRegion #First letter uppercase
  SYMBOL_NAME = :sys_state_x_region #lowercase and separated by underscore
  PARAMETERS = :sys_state_id, :sys_region_id  #Used by the getter, getting the params from specific models
