class HrInsurancePlansController < ApplicationController
  ...
  MODEL_NAME = HrInsurancePlan #First letter uppercase
  SYMBOL_NAME = :hr_insurance_plan #lowercase and separated by underscore
  ...
  def create
    ...
    if @model_instance.save
      flash[:msg_success] = 'Plano de saúde cadastrado com sucesso.'
